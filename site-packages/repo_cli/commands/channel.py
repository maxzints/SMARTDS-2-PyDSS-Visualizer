...
class SubCommand(SubCommandBase):
    ...
    def main(self):
        ...
        if self.args.create:
            ...
            for channel_name in self.args.list_packages:
                self.show_channel_packages(channel_name, full_details=self.args.full_details)
    ...
    def show_channel_packages(self, channel_name, full_details=False):
        packages = self.api.get_channel_artifacts(channel_name)
        ...
        if full_details:
            ...
            self.log.info(formatter.format(packages=packages, metadata={}, simple=True))
    ...
    def show_channel_files(self, spec, family, full_details=False):
        ...
        self.log.info('Found %s files matching the specified spec %s:' % (total_count, spec))
    ...
    def add_parser(self, subparsers):
        ...
        subparser.add_argument('--family',
                               ...
                               help='artifact family (i.e.: conda, python, cran, anaconda_project, '
                                    'anaconda_env, notebook). ONLY USED IN COMBINATION '
        ...
        group.add_argument('--list-packages',
                            help='Channel name written as <channel>[/<subchannel>]',
