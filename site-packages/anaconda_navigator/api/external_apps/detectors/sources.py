...
if typing.TYPE_CHECKING:
    ...
    WindowsRegistryRoot = typing_extensions.Literal[
        'HKEY_CLASSES_ROOT',
        'HKEY_CURRENT_USER',
        'HKEY_LOCAL_MACHINE',
        'HKEY_USERS',
...
# NOTE: might be replaced with `WindowsRegistryRoot.__args__` with python 3.8+
WINDOWS_REGISTRY_ROOT_KEYS: 'typing_extensions.Final[typing.Tuple[WindowsRegistryRoot, ...]]' = (
    'HKEY_CLASSES_ROOT',
    'HKEY_CURRENT_USER',
    'HKEY_LOCAL_MACHINE',
    'HKEY_USERS',
...
class CheckWindowsRegistry(core.Source, metaclass=abc.ABCMeta):  # pylint: disable=too-few-public-methods
    ...
    def __init__(self, *args: RegistryKey) -> None:
        ...
        self.__content: 'typing_extensions.Final[typing.Tuple[RegistryKey, ...]]' = args
    ...
    def _values(self) -> typing.Iterator[str]:
        ...
        for item in self.__content:
            ...
            try:
                key: winreg.HKEYType
                with winreg.OpenKeyEx(getattr(winreg, item.root), item.key) as key:
