...
if typing.TYPE_CHECKING:
    ...
    class RecursiveIterable(typing_extensions.Protocol[TCov]):  # pylint: disable=too-few-public-methods
        """Iterable that can yield another recursive iterable alongside other items."""

        def __iter__(self) -> typing.Iterator[typing.Union[TCov, RecursiveIterable[TCov]]]:
...
INLINE_VALUE_PATTERN: 'typing_extensions.Final[typing.Pattern[str]]' = re.compile(r'{([^}]*)}')
