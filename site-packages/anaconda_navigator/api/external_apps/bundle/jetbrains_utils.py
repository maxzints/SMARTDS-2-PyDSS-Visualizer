...
if typing.TYPE_CHECKING:
    ...
    JetBrainsProductCode = typing_extensions.Literal['PY', 'PC', 'PE', 'DS']


# NOTE: might be replaced with `PyCharmProductCode.__args__` with python 3.8+
JET_BRAINS_PRODUCT_CODE_KEYS: 'typing_extensions.Final[typing.Tuple[JetBrainsProductCode, ...]]' = (
    'PY', 'PC', 'PE', 'DS',
)
...
JETBRAINS_PRODUCTS: 'typing_extensions.Final[typing.Mapping[JetBrainsProductCode, ProductDetails]]' = {
...
class JetBrainsVersionChecker(detectors.Filter):  # pylint: disable=too-few-public-methods
    ...
    build_pattern: 'typing_extensions.Final[typing.Pattern[str]]' = re.compile(
        r'(?P<product>[a-zA-Z0-9]+)-(?P<build>[0-9.]+)',
    )
    known_builds: 'typing_extensions.Final[typing.Mapping[str, str]]' = {
        '101.15': '1.1.1',
        '105.58': '1.2.1',
        '107.756': '1.5.4',
        '111.291': '2.0.2',
    ...
    def __init__(
        ...
        self.__product_code: 'typing_extensions.Final[typing.Tuple[JetBrainsProductCode, ...]]' = product_code
        self.__product_info_path: 'typing_extensions.Final[str]' = product_info_path
        self.__build_path: 'typing_extensions.Final[str]' = build_path
