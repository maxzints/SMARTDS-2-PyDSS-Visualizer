...
if typing.TYPE_CHECKING:
    ...
    class ValueChecker(typing_extensions.Protocol):  # pylint: disable=too-few-public-methods
...
TKeyInv = typing.TypeVar('TKeyInv', str, int)
...
def iterable_items(source: typing.Iterable[TInv]) -> typing.Iterator[TInv]:
    """
...
def mapping_items(source: typing.Mapping[TKeyInv, TInv]) -> typing.Iterator[typing.Tuple[TKeyInv, TInv]]:
    """
...
def get_mapping_item(
        mapping: typing.Mapping[TKeyInv, typing.Any],
        item: TKeyInv,
...
def pop_mapping_item(
        mapping: typing.MutableMapping[TKeyInv, typing.Any],
        item: TKeyInv,
        default: typing.Any = EMPTY,
) -> typing.Any:
    """
...
is_str: 'typing_extensions.Final[ValueChecker]' = of_type(str)
is_str_or_none: 'typing_extensions.Final[ValueChecker]' = of_type(str, allow_none=True)

is_int: 'typing_extensions.Final[ValueChecker]' = of_type(int)
is_int_or_none: 'typing_extensions.Final[ValueChecker]' = of_type(int, allow_none=True)

is_bool: 'typing_extensions.Final[ValueChecker]' = of_type(bool)
is_bool_or_none: 'typing_extensions.Final[ValueChecker]' = of_type(bool, allow_none=True)

is_str_sequence: 'typing_extensions.Final[ValueChecker]' = all_of(of_type(typing.Sequence), each_item(is_str))
is_int_sequence: 'typing_extensions.Final[ValueChecker]' = all_of(of_type(typing.Sequence), each_item(is_int))
