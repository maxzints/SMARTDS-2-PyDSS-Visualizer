...
class _AnacondaAPI(QObject):  # pylint: disable=too-many-instance-attributes,too-many-public-methods
    ...
    def is_offline(self):  # pylint: disable=missing-function-docstring
    ...
    def load_repodata(self, prefix=None):
        ...
        def _load_channels(base_worker, info, error):
            ...
            logger.debug('Loading repodata for channels `%s`', channels)
    ...
    def check_navigator_dependencies(self, actions, prefix):  # pylint: disable=too-many-branches,too-many-locals
    ...
    def generate_rc_key(
        ...
        logger.debug(
            ...
            'brand: `%s` domain: `%s` user_id: `%s`', result, logged_brand, logged_api_url, user_id
        )
        return result
    ...
    def client_reset_ssl(self) -> None:
        ...
        ssl_verification: bool = self.config.get('main', 'ssl_verification', True)
        ssl_certificate: typing.Optional[str] = self.config.get('main', 'ssl_certificate', None)
