...
STRING_ESCAPES: 'typing_extensions.Final[typing.Mapping[str, str]]' = {
    '\"': '\\"',
    '\\': '\\\\',
    '/': '\\/',
    '\b': '\\b',
...
class JsonSerializer(metaclass=abc.ABCMeta):
    ...
    def __init__(self, *types: typing.Type[typing.Any]) -> None:
        ...
        self.__types: 'typing_extensions.Final[typing.Tuple[typing.Type[typing.Any], ...]]' = types
...
class JsonContext:
    ...
    def __init__(
        ...
        self.__configuration: 'typing_extensions.Final[typing.Mapping[str, typing.Any]]' = configuration
        self.__serializers: 'typing_extensions.Final[typing.Sequence[JsonSerializer]]' = serializers
        self.__state: 'typing_extensions.Final[typing.MutableMapping[str, typing.Any]]' = {}
        self.__stream: 'typing_extensions.Final[typing.TextIO]' = stream
...
class JsonWriter:
    ...
    def __init__(
        ...
        self.__context: 'typing_extensions.Final[JsonContext]' = JsonContext(
