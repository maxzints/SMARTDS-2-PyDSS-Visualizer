...
TConException = typing.TypeVar('TConException', bound=BaseException, contravariant=True)

if typing.TYPE_CHECKING:
    import typing_extensions

    class Handler(typing_extensions.Protocol[TConException]):  # pylint: disable=too-few-public-methods
        """Common protocol for error handling functions."""

        def __call__(self, exception: TConException) -> typing.Any:
            """
            Execute handler.
    ...
    class Parser(typing_extensions.Protocol[TConException]):  # pylint: disable=too-few-public-methods
        """Common protocol for context parsers for exceptions."""

        def __call__(self, exception: TConException) -> typing.Tuple[typing.Any, ...]:
            """
...
class ErrorHandlers:
    ...
    def __init__(self) -> None:
        ...
        self.__handlers: 'typing_extensions.Final[typing.List[ErrorHandler]]' = []
        self.__parsers: 'typing_extensions.Final[typing.List[ErrorParser]]' = []
    ...
    def register_handler(
            self,
            exception_type: typing.Type[TConException],
            handler: 'Handler[TConException]',
            *context: typing.Any,
    ) -> None:
        """
    ...
    def register_parser(self, exception_type: typing.Type[TConException], parser: 'Parser[TConException]') -> None:
        """
...
class HttpErrorHandlers(ErrorHandlers):
    """Collection of error handlers, which is prepared to parse HTTP requests from NucleusAPI."""
