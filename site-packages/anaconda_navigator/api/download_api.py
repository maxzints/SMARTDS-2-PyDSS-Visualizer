...
def local_test():  # pragma: no cover
    ...
    for i, url in enumerate(urls):
        ...
        worker.url = url  # pylint: disable=attribute-defined-outside-init
    ...
    api = DownloadAPI()
    print(api._is_valid_api_url('https://api.anaconda.org'))  # pylint: disable=protected-access
    print(api._is_valid_api_url('https://conda.anaconda.org'))  # pylint: disable=protected-access
    print(api._is_valid_channel('https://google.com'))  # pylint: disable=protected-access
    print(api._is_valid_channel('https://conda.anaconda.org/continuumcrew'))  # pylint: disable=protected-access
