...
class HomeTab(WidgetBase):  # pylint: disable=too-many-instance-attributes
    ...
    def set_applications(
        self,
        applications: typing.Mapping['api_types.ApplicationName', 'api_types.RawApplication'],
    ) -> None:
        ...
        processed_applications: typing.List['api_types.Application'] = sorted(
            ...
            key=lambda app: (app.get('name') != 'dataspell', not app.get('installed'), app.get('name', '')),
        )
    ...
    def refresh_cards(self):
        ...
        """
        self.tracker.track_event('home', 'click', 'Refresh')
        self.list.update_style_sheet()
        self.list.repaint()
    ...
    def show_channels(self):
        ...
        self.tracker.track_event('home', 'click', 'Channels')
    ...
    def update_status(self, action='', message='', value=None, max_value=None):
        ...
        action = fm.elidedText(action, Qt.ElideRight, round(max_status_length * msg_percent, 0))
        message = fm.elidedText(message, Qt.ElideRight, round(max_status_length * (1 - msg_percent), 0))
