...
class CondaPackagesWidget(QWidget):  # pylint: disable=too-many-instance-attributes
    ...
    def filter_package(self, value):
        ...
        self.tracker.track_event('environments', 'filter_by', value)
    ...
    def show_channels(self):
        """Show channel dialog."""
        self.tracker.track_event('environments', 'click', 'Channels')
    ...
    def update_package_index(self):
        ...
        self.tracker.track_event('environments', 'click', 'Update index...')
