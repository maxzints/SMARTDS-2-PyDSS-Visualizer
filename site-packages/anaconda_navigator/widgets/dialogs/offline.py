...
class DialogOfflineMode(DialogBase):
    ...
    WIDTH = 460
    _MESSAGE_BASE = str(
        'Some of the functionality of Anaconda Navigator will be limited. Conda environment creation will be subject '
        'to the packages currently available on your package cache.<br><br>'
    )
    _MESSAGE_LOC = str(
        '<b>Offline mode</b> is indicated to the left of the login/logout button on the top right corner of the main '
        'application window.<br><br>'
    )
    _MESSAGE_ENABLE = (
        'Offline mode will be disabled automatically when internet connectivity is restored.<br><br>'
    )
    _MESSAGE_FORCE = (
