...
from anaconda_navigator.utils.py3compat import parse, to_text_string
...
class MessageBox(DialogBase):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-arguments,too-many-statements
            self, type_, error='', title='', text='', learn_more=None, json=False, parent=None, analytics=True
    ):
        """Base message box dialog."""
        super().__init__(parent)
        from anaconda_navigator.utils.analytics import GATracker  # pylint: disable=import-outside-toplevel

        self.tracker = GATracker() if analytics else None
...
```
'''
        info = self.tracker.info if self.tracker else {}
