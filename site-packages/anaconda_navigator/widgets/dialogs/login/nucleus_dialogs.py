...
from qtpy.QtWidgets import QApplication, QWidget  # pylint: disable=no-name-in-module
...
NUCLEUS_LOGIN_TEXT_CONTAINER = TextContainer(
    title='Sign In',
    info_frame_text=(
        'Log into Anaconda Nucleus to backup your environment and access more data science tools. If you don’t have '
...
class NucleusLoginPage(BaseLoginPage):  # pylint: disable=missing-class-docstring
    ...
    def __init__(self, parent: typing.Optional[QWidget] = None) -> None:
        ...
        self.brand = AnacondaBrand.NUCLEUS
    ...
    def __process_login_response(self, result: nucleus_api.TaskResult) -> None:
        ...
        if result.status != nucleus_api.TaskStatus.SUCCEEDED:
            error: BaseException = typing.cast(BaseException, result.exception)
            error_msg = str(error)
    ...
    def update_links(self):
        ...
        base_url = base_url.rstrip('/')  # pylint: disable=no-member
