...
from . import styling
from .utils import TextContainer, USER_RE_VALIDATOR
...
ENTERPRISE_SET_DOMAIN_TEXT_CONTAINER = TextContainer(
    ...
    info_frame_logo_path=ANACONDA_ENTERPRISE_LOGIN_LOGO,
    info_frame_text=(
        'Login to configure Conda and Navigator to installpackages from your on-premise package  repository.'
    )
)
...
class NoticePage(StaticDialogBase):
    ...
    def __init__(
        ...
        self.tracker: analytics._GATracker = analytics.GATracker()
